			...
			>
				<div className="flex flex-col p-4 sm:p-5">
					...
					{manager.formatsQuery.error ? (
						<ErrorNotice error={manager.formatsQuery.error} />
					) : null}
					{manager.progressQuery.error ? (
						<ErrorNotice error={manager.progressQuery.error} />
					) : null}
					{manager.startMutation.error ? (
						<ErrorNotice error={manager.startMutation.error} />
					) : null}
